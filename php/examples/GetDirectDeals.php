...
/**
 * This example illustrates how to retrieve all direct deals associated with
 * the user.
 *
...
class GetDirectDeals extends BaseExample {
  public function run() {
    ...
    if (!isset($result['directDeals']) || !count($result['directDeals'])) {
      print '<p>No direct deals found</p>';
      return;
    }
    foreach ($result['directDeals'] as $directDeal) {
