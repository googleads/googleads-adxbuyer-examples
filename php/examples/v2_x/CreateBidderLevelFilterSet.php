...
/**
 * This example illustrates how to create a Bidder-level Filter Set.
 */
class CreateBidderLevelFilterSet extends BaseExample
{
  ...
  public function run() {
    ...
    print sprintf(
        '<h2>Creating Bidder-level filter set for ownerName %s</h2>',
        $ownerName
    );
    ...
    $result = $this->service->bidders_filterSets->create(
  ...
  public function getName() {
    return 'RTBTroubleshooting: Create Bidder-level Filter Set';
  }
}
