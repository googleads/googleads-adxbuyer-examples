...
/**
 * This example illustrates how to retrieve Account-level Bid Metrics.
 *
 ...
 */
class ListAccountLevelBidMetrics extends BaseExample {
  ...
  public function run() {
    ...
    $result = $this->service->bidders_accounts_filterSets_bidMetrics
        ->listBiddersAccountsFilterSetsBidMetrics($filterSetName);
    print sprintf(
        '<h2>Listing Account-level Bid Metrics for filterSet "%s"</h2>',
        $filterSetName
    );
  ...
  public function getName() {
    return 'RTB Troubleshooting: List Account-level Bid Metrics';
  }
}
