...
def create_invitation(ad_exchange_buyer, account_id, client_buyer_id,
    new_invitation)
  begin
...
if __FILE__ == $0
  ...
  new_invitation.email = opts['email']

  create_invitation(service, opts['account_id'], opts['client_buyer_id'],
      new_invitation
  )
end
