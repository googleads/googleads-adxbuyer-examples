...
def update_client_buyer(ad_exchange_buyer, account_id, client_buyer_id,
...
if __FILE__ == $0
  ...
  updated_client_buyer.visible_to_seller = opts['visible_to_seller']
  updated_client_buyer.status = opts['status']
  updated_client_buyer.entity_type = opts['entity_type']
  updated_client_buyer.role = opts['role']
  updated_client_buyer.client_name = opts['client_name']
  updated_client_buyer.client_account_id = opts['client_buyer_id']
  updated_client_buyer.entity_id = opts['entity_id']

  update_client_buyer(service, opts['account_id'], opts['client_buyer_id'],
      updated_client_buyer)
end
