...
def list_performance_report(ad_exchange_buyer, account_id, end_date_time,
    start_date_time, max_results)
  begin
...
if __FILE__ == $0
  ...
  list_performance_report(service, opts['account_id'], opts['end_date_time'],
