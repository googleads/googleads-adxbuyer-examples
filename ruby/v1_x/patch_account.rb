...
def patch_account(
    ad_exchange_buyer, account_id, account_patch,
...
if __FILE__ == $0
  ...
  account_patch = Google::Apis::AdexchangebuyerV1_4::Account.new(
      cookie_matching_url: opts['cookie_matching_url']
  )

  patch_account(
      service, opts['account_id'], account_patch, opts['confirm_unsafe_change']
  )
end
