...
{
    /// <summary>
    /// Retrieves bidder-level bid metrics for the given bidder and filter set resource IDs.
    /// </summary>
    public class ListBidderLevelBidMetrics : ExampleBase
    {
        ...
        public static void Main(string[] args)
        {
            ...
            ExampleBase example = new ListBidderLevelBidMetrics();
        ...
        {
            get { return "This code example lists bidder-level bid metrics "
                    + "for the given bidder and filter set resource IDs."; }
        }
