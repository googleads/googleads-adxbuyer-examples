...
{
    /// <summary>
    /// Retrieves the authenticated user's list of client users for the given
    ...
    public class ListClientUsers : ExampleBase
    {
        ...
        {
            get { return "This code example lists all client users for a "
        ...
        public override void Run(BaseClientService service)
        {
            ...
            ListClientUsersResponse response = adXService.Accounts.Clients.Users
                .List(accountId, clientBuyerId).Execute();

            Console.WriteLine("========================================\n");
            Console.WriteLine("Listing of client users associated with AdX "
